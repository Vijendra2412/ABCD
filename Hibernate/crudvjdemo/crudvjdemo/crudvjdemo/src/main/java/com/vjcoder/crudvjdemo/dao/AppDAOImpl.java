...
//        retrieve the instructor
        Instructor temInstructror = entityManager.find(Instructor.class,theId);

//        delete the instructor
        entityManager.remove(temInstructror);
    }
    ...
    @Override
    @Transactional
    public void deleteIntstructorDetailsById(int theId) {
